...
Call suListarChamados(Me.cboStatus.Text, gintUsuarioID)
...
Private Sub suListarChamados(ByVal vStatus As String, ByVal vUsuarioID)
Call ConectarBD
...
If rs.EOF = False Then
    Do While Not rs.EOF
        Set lvwItem = Me.lvwAcompanharOS.ListItems.Add(, , Format(rs!OSID, "0000"))
