...
PermissaoAD = False
 On Error GoTo ErrHandler
    ...
    domain = "LDAP://cablenabr.local" ' Ajuste para o seu domínio AD
...
'Dim p As String
'p = "CN=Endrick Micael Peres Fernandes,OU=Users,OU=Administrators,OU=Empresas,DC=cablenabr,DC=local"
...
Set objUser = GetObject("LDAP://" & VCompletoDN)
...
Public Function GetUserDN(ByVal sUserName As String) As String
    ...
    sDomain = "DC=cablenabr,DC=local"  ' Ajuste aqui para refletir o seu domínio
    
    ldapPath = "LDAP://" & sDomain
...
Private Sub GetUserFullName(ByVal sUserName As String)
    ...
    sQuery = "<LDAP://" & sDomain & ">;(sAMAccountName=" & sUserName & ");cn;subtree"
