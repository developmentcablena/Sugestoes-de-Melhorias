...
On Error GoTo Erro
    ...
    poSendMail.FromDisplayName = "Ricardo Nunes"
    ...
    If Trim(VElemento) = Trim("6.1 - Responsabilidade da direção") Then
        poSendMail.Recipient = "emperes@cablena.com.br" '"cplavie@cablena.com.br;ricardotrevisan@cablena.com.br"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
        
    ElseIf VElemento = "6.2 - Manufatura de Fluxo" Then
        poSendMail.Recipient = "emperes@cablena.com.br"    ' "cplavie@cablena.com.br;ricardotrevisan@cablena.com.br;clebersantos@cablena.com.br"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
        
    ElseIf VElemento = "6.3 - Ambiente e envolvimento dos colaboradores" Then
        poSendMail.Recipient = "emperes@cablena.com.br"   '"cplavie@cablena.com.br;ricardotrevisan@cablena.com.br;llopes@cablena.com.br"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
    
    ElseIf VElemento = "6.4 - Administração visual" Then
        poSendMail.Recipient = "emperes@cablena.com.br"  '"ricardotrevisan@cablena.com.br;"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
    
    ElseIf VElemento = "6.5 - Qualidade" Then
        poSendMail.Recipient = "emperes@cablena.com.br"     '"ricardotrevisan@cablena.com.br;clebersantos@cablena.com.br"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
        
    ElseIf VElemento = "6.6 - Disponibilidade Operacional" Then
        poSendMail.Recipient = "emperes@cablena.com.br"  '"ricardotrevisan@cablena.com.br;arbarbeiro@cablena.com.br;a.martorano@cablena.com.br"
        poSendMail.CcRecipient = "simac_eletricos@cablena.com.br"
        
    ElseIf VElemento = "6.7 - Movimento de materiais" Then
        poSendMail.Recipient = "emperes@cablena.com.br"  '"ricardotrevisan@cablena.com.br;mpaixao@cablena.com.br.josealopes@cablena.com.br"
        poSendMail.CcRecipient = "" '"simac_eletricos@cablena.com.br"
    Else
...
Erro:
    Screen.MousePointer = 0
    Me.Enabled = True
    MsgBox "Erro: " & Err.Description, vbCritical, "Suporte Simac email"
    Set poSendMail = Nothing
End Function
...
'On Error GoTo Erro
    strSQL = "SELECT * FROM vw_Chamados WHERE OSID = " & vAtendimento
    ...
    If rs.EOF = False Then
        ...
        strRelatorio = strRelatorio & "Nº do Atendimento: " & Format(rs!OSID, "0000") & vbCrLf & vbCrLf
