...
Begin VB.Form frmSuporteSistemas 
   ...
   Begin VB.ComboBox cboAtendente 
      ...
      BackColor       =   &H80000018&
      Height          =   315
      ItemData        =   "frmSuporteSistemas.frx":12CA
      Left            =   2520
      List            =   "frmSuporteSistemas.frx":12CC
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   1035
...
Private Sub cmdCadastrar_Click()
    ...
    If fnCadastrarOS(Me.cboTipo, Me.cboLocal, Me.cboAtendente, Me.txtObservacao, gstrNome, gstrDepto, gstrEMail, gintUsuarioID, Me.txtPropostaResultado) = True Then
        MsgBox "Atendimento N° " & Format(gintOSID, "0000") & " gerada com sucesso!", vbOKOnly + vbInformation, "Suporte Simac"
        Call LimparDados
    End If

End Sub
Private Function fnCadastrarOS(ByVal vTipo As String, ByVal vLocal As String, ByVal vAtendente As String, ByVal vObservacao As String, VUsuario As String, ByVal vDepartamento As String, ByVal vEMail As String, ByVal vUsuarioID, ByVal vDescricao2) As Boolean
On Error GoTo Erro
    fnCadastrarOS = False
    gintOSID = 0
...
Dim poSendMail As vbSendMail.clsSendMail
    ...
    End If
    poSendMail.Recipient = "simac_eletricos@cablena.com.br"
    poSendMail.RecipientDisplayName = "ADM Suporte Simac"
    poSendMail.CcRecipient = "emperes@cablena.com.br"
    poSendMail.Subject = "Suporte Simac - Novo Atendimento " & Format(vOSID, "0000")
