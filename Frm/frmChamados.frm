...
Begin VB.Form frmChamados 
   ...
   Begin VB.CommandButton cmdBaixarOS 
      ...
      Width           =   1335
   End
   Begin VB.PictureBox lvwChamados 
      BackColor       =   &H80000018&
      ForeColor       =   &H80000008&
      Height          =   8415
      Left            =   120
...
Select Case vStatus
    Case "Em Aberto"
        strSQL = "SELECT * FROM vw_Chamados WHERE OSID = " & vOSID & " AND Status = 0 "
    Case "Em Atendimento"
 ...
 If Not rs.EOF Then
    With Me.lvwChamados.ListItems.Add(, , Format(rs!OSID, "0000"))
...
On Error GoTo Erro
        ...
        strSQL = "UPDATE tb_OS SET Status = 1 WHERE OSID =  " & vOSID & ""
        Set rs = New ADODB.Recordset
        rs.Open strSQL, cn, adOpenKeyset, adLockOptimistic
...
Dim lvwItem As ListItem
    ...
    If rs.EOF = False Then
        Do While Not rs.EOF
            Set lvwItem = Me.lvwChamados.ListItems.Add(, , Format(rs!OSID, "0000"))
                If Len(rs!Nome) > 0 Then
